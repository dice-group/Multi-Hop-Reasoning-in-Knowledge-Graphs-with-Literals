...
# To reproduce the results reported in Table 5. Doesnt'work
Traceback (most recent call last):
  File "eval_attribute_filtering_example.py", line 27, in <module>
    load_model(model, checkpoint_path, train_config.cuda)
  File "/local/upb/users/c/cdemir/profiles/unix/cs/Multi-Hop-Reasoning-in-Knowledge-Graphs-with-Literals/util_models.py", line 180, in load_model
    data = torch.load(checkpoint, map_location=torch.device('cuda:0') if cuda else torch.device('cpu'))
  File "/upb/users/c/cdemir/profiles/unix/cs/.conda/envs/litcqd/lib/python3.8/site-packages/torch/serialization.py", line 594, in load
    with _open_file_like(f, 'rb') as opened_file:
  File "/upb/users/c/cdemir/profiles/unix/cs/.conda/envs/litcqd/lib/python3.8/site-packages/torch/serialization.py", line 230, in _open_file_like
    return _open_file(name_or_buffer, mode)
  File "/upb/users/c/cdemir/profiles/unix/cs/.conda/envs/litcqd/lib/python3.8/site-packages/torch/serialization.py", line 211, in __init__
    super(_open_file, self).__init__(open(name, mode))
FileNotFoundError: [Errno 2] No such file or directory: './checkpoints_FB15K-237/checkpoint_orig_attr_kblrn_desc/checkpoint'
