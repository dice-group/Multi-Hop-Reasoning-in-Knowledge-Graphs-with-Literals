...
def main(args):
    ...
    # Set args.train_config.do_train = True for the debugging.
    ...
    if train_config.do_tune:
        ...
        if train_config.do_train:
            train(train_config, cqd_params)(vars(params), nentity, nrelation, nattribute, train_data_rel,
                                            ...
                                            valid_answers_easy, valid_answers_hard,
                                            eval_train_queries, eval_train_answers,
                                            checkpoint_dir=train_config.checkpoint_path)
